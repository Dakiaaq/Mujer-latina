      ...
      <div className="bg-[#fcfcfc] min-h-screen py-8 sm:py-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          {isProfileEditing ? (
            ...
            <>
              {/* Profile Header Card */}
              <div className="bg-white p-6 sm:p-8 rounded-3xl border border-stone-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden" id="profile-main-header">
                <div className="flex items-center gap-5">
                  {/* Normal Avatar Display */}
                  <div className="relative w-20 h-20 sm:w-22 sm:h-22 rounded-full overflow-hidden border-2 border-[#d4af37] shadow-md bg-stone-100 flex-shrink-0">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-[#d4af37]/20 text-[#b58d24] border border-[#d4af37]/40 uppercase tracking-wider">
                        {currentUser.role === 'admin' ? 'ADMINISTRADOR' : 'CLIENTE'}
                      </span>
                    </div>
                    <p className="text-stone-500 text-xs sm:text-sm mt-0.5 flex items-center gap-2">
                      <Mail size={13} /> {currentUser.email}
                    </p>
                    <p className="text-stone-400 text-xs mt-0.5">
                      Miembro desde {currentUser.memberSince || '2024'}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-stone-100 hover:bg-[#d4af37] text-stone-800 hover:text-black border border-stone-200 hover:border-[#d4af37] rounded-full text-xs font-bold transition flex items-center gap-1.5 shadow-sm"
                  ...
                  {currentUser.role === 'admin' && (
                    <button
                      ...
                      className="px-4 py-2 bg-stone-900 hover:bg-[#d4af37] text-white hover:text-black rounded-full text-xs font-bold tracking-wide transition flex items-center gap-1.5 shadow"
                  ...
                  <button
                    onClick={logout}
                    className="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-full text-xs font-semibold transition flex items-center gap-1.5"
                    id="logout-btn"
                  >
                    <LogOut size={14} />
      ...
      <div className="max-w-md w-full mx-4 bg-white p-8 rounded-3xl border border-stone-200 shadow-xl space-y-6">
        ...
        {authMode === 'login' ? (
          ...
          <form onSubmit={handleRegisterSubmit} className="space-y-3 text-xs sm:text-sm">
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3.5 bg-[#d4af37] hover:bg-[#c29e2f] text-black font-bold rounded-full transition duration-200 shadow"
            >
              Crear Cuenta Segura
            </button>
          </form>
