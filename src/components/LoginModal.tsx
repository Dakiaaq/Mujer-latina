...
export const LoginModal: React.FC<LoginModalProps> = ({ controller }) => {
  ...
  return (
    ...
    >
      <div 
        className={`relative w-full ${modalMode === 'register' ? 'max-w-xl' : 'max-w-md'} bg-white border-t-4 border-[#d4af37] border-x border-b border-stone-200 rounded-3xl p-6 sm:p-8 shadow-2xl text-stone-800 transition-all duration-300 max-h-[92vh] overflow-y-auto custom-scrollbar`}
      ...
      >
        ...
        {modalMode === 'register' && (
          <div className="space-y-6">
            ...
            {/* Switch to Login link (Under the button) */}
