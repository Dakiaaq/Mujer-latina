...
export const AdminDashboardView: React.FC<AdminDashboardViewProps> = ({ controller }) => {
  ...
  return (
    <div className="p-6 sm:p-10 space-y-8 bg-stone-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 bg-stone-900 text-white rounded-xl text-xs font-semibold hover:bg-stone-800 transition flex items-center gap-1.5 shadow-sm"
          >
            <ShoppingBag size={14} />
