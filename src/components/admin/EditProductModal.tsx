...
export const EditProductModal: React.FC<EditProductModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
      <div 
        className="bg-white w-full max-w-2xl rounded-2xl sm:rounded-3xl shadow-2xl border border-stone-200 overflow-hidden my-6 animate-in fade-in zoom-in-95 duration-150"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 bg-white border border-stone-200 rounded-xl text-xs sm:text-sm text-stone-800 font-mono placeholder-stone-400 focus:outline-none focus:border-[#d4af37] focus:ring-2 focus:ring-[#d4af37]/20 transition"
              />
            </div>
          ...
          <div className="pt-4 border-t border-stone-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-black hover:bg-stone-900 text-[#d4af37] font-semibold rounded-xl text-xs sm:text-sm transition flex items-center gap-2 shadow-md hover:shadow-lg"
            >
              <Save size={15} />
